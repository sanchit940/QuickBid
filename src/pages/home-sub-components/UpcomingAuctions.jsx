    ...
    <>
      <section className="my-8">
        ...
        <div className="flex flex-wrap gap-6">
          <div  className="bg-[#161613] w-full p-2 gap-10 rounded-md flex flex-col justify-between lg:flex-1 lg:h-auto lg:p-6 2xl:flex-none 2xl:basis-64 2xl:flex-grow 2xl:px-5  2xl:py-6">
